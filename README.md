...
Spring Boot demo integrating Azure Cache for Redis.

This is a **scaffold**. The build, CI, release, and container machinery are
complete and green; the Azure Cache for Redis integration itself is not wired up yet — see
...
```bash
git clone https://github.com/rubensgomes-org/azure-redis.git
cd azure-redis
```
...
└── app/
    ...
    └── src/
        ...
        ├── main/java/com/rubensgomes/azure/redis/
